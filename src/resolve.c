...
static int
resolve_augment(struct lys_node_augment *aug, struct lys_node *parent, struct ly_module *module, unsigned int line)
{
...
{
    return resolve_unique((struct lys_node *)uniq->leafs, uniq_str, uniq, line);
}
